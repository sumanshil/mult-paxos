...
class Agent:
    ...
    def _send_message(self, node: str, url: str, message: Message) -> None:
        self.__executor.submit(lambda : send(node, url, dataclasses.asdict(message)))
...
class Replica(Agent):
    ...
    def __init__(self, config: Config, port: int, propose_url: str):
        ...
        self._propose_url: str = propose_url
        ...
        # ClientRequests we have received but haven't yet proposed.
